<div class="col-xs-12 col-md-8">
			...
			<form method="POST" action="/Skapa-annons/Granska" enctype="multipart/form-data"> 
				...
				<div class="form-group">
					...
					<input class="form-control" placeholder="E-postadress" name="company_email" type="text" id="publisher[email]" value="{!! $previewData->company_email !!}">
					<p>
				...
				<div class="form-group">
					...
					<input class="form-control" placeholder="Företagsnamn" name="company_name" value="{!! $previewData->company_name !!}" type="text" id="company[name]">
				</div>
				<div class="form-group">
					<label for="company_website">Webbplats</label>
					<input class="form-control" placeholder="Webbplats" name="company_website" type="text" id="company[website]" value="{!! $previewData->company_website !!}">
					<p>
				...
				<div class="form-group">
					...
					<input class="form-control" placeholder="Facebook-sida" name="company_facebook" type="text" id="company[facebook]" value="{!! $previewData->company_facebook !!}">
					<p>
				...
				<div class="form-group">
					...
					<p><input name="company[logo]" type="file" id="company_logo"></p>
					<p>
			...
			<div class="left-box">
				...
				<div class="form-group">
					...
					<input class="form-control" placeholder="Annonstitel" name="post_title" type="text"  value="{!! $previewData->post_title !!}" id="title">
				</div>
				<div class="form-group">
					<label for="post_body" class="required">Annonstext <span class="redstar">*</span></label>

					<textarea class="ckeditor form-control" name="post_body">{!! $previewData->post_body !!}</textarea>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group select_city">
							...
							<!--<select name="company_location" class="form-control" id="city">
								<option value="1"> Välj ort/kommun </option>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select placeholder="Välj kategori" name="category" class="form-control" id="category">
								...
								@if($previewData->category == $category->id)
							...
							<div class="input-group">
								...
								<input class="form-control datepicker" name="expiration_date" type="text" id="datepicker" value="{!! $previewData->expiration_date !!}">
							</div>
							<p>
